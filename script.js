...
*/
Papa.parse("https://raw.githubusercontent.com/Lunalaffx/DNO037-clase5/main/indice-uso-cobre.csv", {
    download: true,
    header: true,
    dynamicTyping: true,
                ...
                new Chart(document.querySelector("#grafico").getContext("2d"), {
                    ...
                    data: {
                        ...
                        datasets: [
                            {
                                data: indice,
                                backgroundColor: "rgba(84, 74, 125, .1)",
                                borderColor: "rgba(84, 74, 125, .5)",
                                pointRadius: 2,
                                borderWidth: 1,
                                lineTension: 0,
                            },
